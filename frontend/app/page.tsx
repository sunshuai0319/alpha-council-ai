...
export default function HomePage() {
  return <main className="landing-page">
    <nav className="landing-nav"><Link className="brand brand--landing" href="/"><span className="brand-mark"><Radio size={17} /></span><span><b>alpha council</b><small>AI trading lab</small></span></Link><div><Link href="/sign-in">Sign in</Link><Link className="landing-button" href="/dashboard">Open console <ArrowUpRight size={15} /></Link></div></nav>
